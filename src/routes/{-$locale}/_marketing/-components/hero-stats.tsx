import type { TAnalyticsStat } from "@/features/analytics";
import { cn } from "@/lib/utils";

export interface IHomeHeroStatsProps {
	stats: TAnalyticsStat[];
	className?: string;
}

export const HomeHeroStats = ({ stats, className }: IHomeHeroStatsProps) => {
	return (
		<div className={cn("mt-14 sm:mt-18", className)}>

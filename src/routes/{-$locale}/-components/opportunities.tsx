...
export interface IHomeOpportunityItem {
	id: string;
	title: string;
	description: string;
	linkLabel: string;
...
export interface IHomeOpportunitiesProps {
	title: string;
	items: IHomeOpportunityItem[];
	className?: string;
}

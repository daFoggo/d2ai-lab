...
export interface IAppNavSubItem {
	title: string;
	href?: string;
	to?: string;
	description?: string;
...
export interface IAppNavItem {
	...
	isExternal?: boolean;
	isActive?: boolean;
	items?: IAppNavSubItem[];
}

export interface IAppNavbarRootProps extends ComponentProps<"header"> {
	children: ReactNode;
	className?: string;
}

export const AppNavbarRoot = ({
	children,
	className,
	...props
}: IAppNavbarRootProps) => {
	...
	// Track whether the header still overlaps the home hero so its color
	...
	useEffect(() => {
		...
		const attach = () => {
			...
			const heroEl = document.querySelector('[data-slot="home-hero"]');
			if (!heroEl) {
				setIsOverHero(false);
				return;
			}
...
export interface IAppNavbarBrandProps {
	name: string;
	tagline?: string;
	logo?: ReactNode;
	hasDropdown?: boolean;
...
export interface IAppNavbarNavProps extends ComponentProps<"div"> {
	children?: ReactNode;
	items?: IAppNavItem[];
	onItemClick?: (item: IAppNavItem) => void;
	className?: string;
}

export const AppNavbarNav = ({
	children,
	items,
	onItemClick,
	className,
...
interface IAppNavbarLanguageSwitcherProps {
	className?: string;
}

const AppNavbarLanguageSwitcher = ({
	className,
}: IAppNavbarLanguageSwitcherProps) => {
...
export const AppNavbar = Object.assign(AppNavbarRoot, {
	Root: AppNavbarRoot,
	Brand: AppNavbarBrand,
	Nav: AppNavbarNav,
	Actions: AppNavbarActions,
});
